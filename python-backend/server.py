...
class DataLoader:
    ...
    def __init__(
        self,
        mongo_con: str = "mongodb://LasuriaRobert:HilbertSpace@larek.tech:9500/",
        pg_con: str = "postgresql+psycopg2://postgres:verystrongpassword@db:5432/dev",
...
class SearchEngingeServicer(search_engine_pb2_grpc.SearchEngineServicer):
    def __init__(self, loader: DataLoader) -> None:
        ...
        ollama = Ollama(
            base_url="http://larek.tech:11434", model="llama2", temperature=0
        )
